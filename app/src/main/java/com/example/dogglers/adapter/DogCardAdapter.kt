...
class DogCardAdapter(
    ...
    override fun onBindViewHolder(holder: DogCardAdapter.DogCardViewHolder, position: Int) {
        ...
        holder.textViewDogName.text = dogItem.name
        holder.textViewDogAge.text = resources?.getString(R.string.dog_age , dogItem.age)
        holder.textViewDogHobbies.text = resources?.getString(R.string.dog_hobbies , dogItem.hobbies)
